...
public static partial class ImageSharpHelper
{
    ...
    public static byte[,] ToGrayArray2D(Image image)
    {
        if (image is null)
        ...
        for (var x = 0; x < width; x++)
        {
            ...
            {
                var color = rgba[x, y];
                result[x, y] = Internal.GrayImageBuffer.ToGray(color.R, color.G, color.B);
            }
        }
    ...
    /// <exception cref="ArgumentNullException"></exception>
    public static byte[,] ToBinaryArray2D(Image image, byte threshold)
    {
        if (image is null)
            throw new ArgumentNullException(nameof(image));
    ...
    /// <exception cref="ArgumentNullException"></exception>
    public static Image CreateImageFromGrayArray(byte[,] grayBytes)
    {
        ...
        for (var x = 0; x < width; x++)
        {
            ...
            {
                var v = grayBytes[x, y];
                output[x, y] = new Rgba32(v, v, v, 255);
            }
        }
    ...
    /// <exception cref="ArgumentNullException"></exception>
    public static Image CreateImageFromBinaryArray(byte[,] binBytes)
    {
        if (binBytes is null)
    ...
    /// <param name="threshold">二值化阈值</param>
    /// <exception cref="ArgumentNullException"></exception>
    public static Image Binaryzation(Image image, byte threshold)
    {
        if (image is null)
            throw new ArgumentNullException(nameof(image));
    ...
    /// <exception cref="ArgumentNullException"></exception>
    public static Image DeepenForeground(Image image, byte threshold = 200)
    {
        if (image is null)
            throw new ArgumentNullException(nameof(image));
    ...
    /// <exception cref="ArgumentNullException"></exception>
    public static Image ClearGrayRange(Image image, byte minGray, byte maxGray)
    {
        if (image is null)
            throw new ArgumentNullException(nameof(image));
    ...
    /// <exception cref="ArgumentNullException"></exception>
    public static Image ClearNoiseByNeighborCount(Image image, byte threshold, int minNeighborCount)
    {
        if (image is null)
            throw new ArgumentNullException(nameof(image));
    ...
    /// <exception cref="ArgumentNullException"></exception>
    public static Image ClearNoiseByArea(Image image, byte threshold, int minAreaSize)
    {
        if (image is null)
            throw new ArgumentNullException(nameof(image));
    ...
    /// <exception cref="ArgumentNullException"></exception>
    public static Image TrimToContent(Image image, byte foregroundThreshold = 128)
    {
        if (image is null)
            throw new ArgumentNullException(nameof(image));
    ...
    /// <param name="threshold">前景阈值</param>
    /// <exception cref="ArgumentNullException"></exception>
    public static int[] GetVerticalProjection(Image image, byte threshold = 128)
    {
        if (image is null)
            throw new ArgumentNullException(nameof(image));
    ...
    /// <param name="threshold">前景阈值</param>
    /// <exception cref="ArgumentNullException"></exception>
    public static int[] GetHorizontalProjection(Image image, byte threshold = 128)
    {
        if (image is null)
            throw new ArgumentNullException(nameof(image));
    ...
    /// <exception cref="ArgumentNullException"></exception>
    public static List<Image> SplitByVerticalProjection(Image image, byte threshold = 128, int minFontWidth = 0, int minLines = 0)
    {
        if (image is null)
            throw new ArgumentNullException(nameof(image));
