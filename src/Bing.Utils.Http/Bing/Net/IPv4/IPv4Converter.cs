...
public static class IPv4Converter
{
    ...
    /// <example>
    /// <code>
    /// string ip = Ip.UInt32ToIp(3232235777);  // 返回 "192.168.1.1"
    /// </code>
    /// </example>
    ...
    /// Console.WriteLine($"网络地址: {network}");  // 192.168.1.0
    /// </code>
    /// </example>
    ...
    /// Console.WriteLine($"广播地址: {broadcast}");  // 192.168.1.255
    /// </code>
    /// </example>
